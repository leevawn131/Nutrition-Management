...
const styles = StyleSheet.create({
  ...
  backButton: { width: 42, height: 42, borderRadius: 21, backgroundColor: '#F1F5F9', alignItems: 'center', justifyContent: 'center' },
  ...
  weekPicker: { flexDirection: 'row', backgroundColor: '#F5F5F9', borderRadius: 18, padding: 4, marginBottom: 28 },
  weekItem: { flex: 1, minHeight: 88, alignItems: 'center', justifyContent: 'center', borderRadius: 16, paddingHorizontal: 4, paddingVertical: 8 },
  ...
  sectionTitle: { fontSize: 23, fontWeight: '800', color: '#10294B' },
  ...
  progressTrack: { height: 7, borderRadius: 4, backgroundColor: '#E2E5E8', marginBottom: 7 },
  ...
  exploreButton: { flexDirection: 'row', alignItems: 'center', gap: 6, backgroundColor: '#49C99B', borderRadius: 22, paddingHorizontal: 14, paddingVertical: 11 },
  exploreText: { color: '#FFFFFF', fontSize: 14, fontWeight: '700' },
  mealGroups: { marginTop: 24 },
  ...
  activityTrack: { height: 9, backgroundColor: '#E2E5E8', borderRadius: 6, marginBottom: 12 },
  ...
  activityDayHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 18 },
