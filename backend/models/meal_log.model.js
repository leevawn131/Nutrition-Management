...
const mealLogSchema = new mongoose.Schema(
  {
    ...
    recognition_summary: {
      recognition_id: { type: mongoose.Schema.Types.ObjectId, ref: 'RecognitionHistory', default: null },
      predicted_label: { type: String, default: null },
      confidence: { type: Number, default: null },
      corrected_label: { type: String, default: null },
    },
  },
  {
    timestamps: false,
...
const MealLog = mongoose.model('MealLog', mealLogSchema, 'meal_logs');
