...
const adminAchievementService = {
  ...
  async createAchievement(data) {
    const { name, description, icon, condition, tier, category, reward_points } = data;
    ...
    const newAchievement = new Achievement({
      ...
      ...(tier ? { tier } : {}),
      ...(category ? { category } : {}),
      ...(reward_points !== undefined && reward_points !== null ? { reward_points: Number(reward_points) } : {}),
      condition: {
        type,
  ...
  async updateAchievement(id, data) {
    ...
    if (reward_points !== undefined && reward_points !== null) {
      achievement.reward_points = Number(reward_points);
    }
