...
export const Dashboard: React.FC = () => {
  ...
  const statCards = [
    ...
    },
    {
      ...
      value: isLoading ? "..." : kpis ? `${kpis.total_recipes}` : "0",
      subtitle: kpis
    ...
    <div className="dashboard-page">
      ...
      <div className="welcome-banner">
        <div className="welcome-text">
          ...
          <p>
            Chào mừng bạn đến với Cổng Quản trị{" "}
            <strong>Nutrition Management</strong>. Bảng điều khiển giúp bạn quản
            lý người dùng, dữ liệu dinh dưỡng và theo dõi toàn diện hệ thống.
          </p>
        </div>
        <div className="system-status-pill">
          <span className="status-dot"></span>
          <span>
            API Backend: <strong>Online</strong>
          </span>
        </div>
      </div>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "14px" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "13px", color: "#64748B", marginTop: "2px" }}>
              Xem biểu đồ xu hướng tăng trưởng người dùng, phân loại mục tiêu
              sức khỏe và thống kê dinh dưỡng.
            </p>
          </div>
        </div>
            ...
            <div className="module-list">
              <div className="module-item module-completed">
                <div className="module-info">
                  <span className="module-name">
                    Admin Web Foundation & Auth Guard
                  </span>
                  <span className="module-desc">
                    Khởi tạo giao diện, xác thực vai trò Admin, bảo vệ tuyến
                    đường
                  </span>
                </div>
                <span className="module-status-badge badge-success">
                  Hoàn thành
                </span>
              </div>
              ...
              <div className="module-item module-completed">
                <div className="module-info">
                  ...
                  <span className="module-desc">
                    Xem danh sách, tìm kiếm, phân quyền tài khoản
                  </span>
                </div>
                <span className="module-status-badge badge-success">
                  Hoàn thành
              ...
              <div className="module-item module-completed">
                <div className="module-info">
                  <span className="module-name">
                    Quản lý Món ăn & Dinh dưỡng (Food Database)
                  </span>
                  <span className="module-desc">
                    CRUD danh mục thực phẩm, calo, macro, kiểm tra ràng buộc
                  </span>
                </div>
                <span className="module-status-badge badge-success">
                  Hoàn thành
              ...
              <div className="module-item module-completed">
                <div className="module-info">
                  <span className="module-name">
                    Kế hoạch mẫu & Thực đơn (Meal Plans & Recipes)
                  </span>
                  <span className="module-desc">
                    Quản trị công thức, kiểm duyệt cộng đồng, tạo gói thực đơn
                  </span>
                </div>
                <span className="module-status-badge badge-success">
                  Hoàn thành
              ...
              <div className="module-item module-completed">
                <div className="module-info">
                  ...
                  <span className="module-desc">
                    Biểu đồ tăng trưởng, cơ cấu người dùng và vận hành
                  </span>
                </div>
                <span className="module-status-badge badge-success">
                  Hoàn thành
        ...
        <div className="content-card">
          ...
          <div className="card-body">
            ...
            <div className="dashboard-tip-box">
              <p>
                💡 <strong>Gợi ý:</strong> Số liệu thống kê được cập nhật theo
                thời gian thực từ cơ sở dữ liệu MongoDB thông qua các truy vấn
                Aggregation bảo toàn tính riêng tư.
              </p>
            </div>
          </div>
        </div>
