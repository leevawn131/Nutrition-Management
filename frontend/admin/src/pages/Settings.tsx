...
export const Settings: React.FC = () => {
  ...
  const handleSaveProfile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setProfileErrorMsg(
        err.response?.data?.message || "Lỗi hệ thống khi cập nhật hồ sơ.",
      );
    } finally {
  ...
  const handleChangePassword = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setPasswordErrorMsg(
        err.response?.data?.message || "Lỗi hệ thống khi đổi mật khẩu.",
      );
    } finally {
      ...
      <div className="page-header-row" style={{ alignItems: "flex-start" }}>
        <div>
          <h1 className="page-heading">
            Cài đặt Hệ thống & Tài khoản Quản trị
          </h1>
          <p className="page-subheading">
            Quản lý thông tin cá nhân, bảo mật tài khoản Admin và kiểm tra thông
            số môi trường hệ thống.
          </p>
          ...
          >
            <button
              ...
              style={{
                ...
                border: "1px solid",
                backgroundColor:
                  activeTab === "profile" ? "#10B981" : "#FFFFFF",
            ...
            <button
              ...
              style={{
                ...
                border: "1px solid",
                backgroundColor:
                  activeTab === "security" ? "#10B981" : "#FFFFFF",
            ...
            <form onSubmit={handleSaveProfile} className="card-body">
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: "240px" }}>
                  ...
                  >
                    Nhập URL ảnh trực tuyến hợp lệ để xem trước ảnh đại diện
                    ngay lập tức.
                  </span>
                </div>
              </div>
        ...
        >
          ...
          <div className="content-card">
            ...
            <form onSubmit={handleChangePassword} className="card-body">
              ...
              >
                ...
                />
                <span>
                  Mật khẩu được mã hóa an toàn bằng thuật toán{" "}
                  <strong>Bcrypt (Salt Factor 10)</strong> trước khi lưu vào cơ
                  sở dữ liệu. Vui lòng ghi nhớ mật khẩu mới.
                </span>
              </div>
          ...
          >
            <div
              ...
              style={{ borderBottomColor: "#FEE2E2" }}
            >
              <div className="card-header-title">
                <LogOut size={20} color="#DC2626" />
                <h3 style={{ color: "#991B1B" }}>
                  Đăng xuất Khỏi Phiên Quản trị
                </h3>
              </div>
            </div>
            <div className="card-body">
              ...
              >
                Đăng xuất sẽ xóa token xác thực hiện tại khỏi trình duyệt. Bạn
                sẽ cần nhập lại thông tin để truy cập Cổng Quản trị.
              </p>
              <button
                onClick={logout}
                style={{
              ...
              <div className="system-info-list">
                ...
                <div className="info-row">
                  ...
                  <span className="info-value font-mono">
                    1.0.0 (Vite 6 + React 19 + TypeScript)
                  </span>
                </div>
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">
                    MongoDB 8.0 (nutrition_app - 27 collections chuẩn)
                  </span>
                </div>
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">
                    JWT Bearer Token + Bcrypt (Cost 10) + RBAC
                  </span>
                </div>
                ...
                <div className="info-row">
                  ...
                  <span className="info-value">
                    Shared Node.js Backend & Mobile App (Expo) / Admin Web
                  </span>
                </div>
              </div>
            </div>
            ...
            <div className="card-body">
              ...
              >
                ...
                >
                  ...
                  <div>
                    <strong>
                      Chế độ hiển thị cô đọng (Compact Table View)
                    </strong>
                    <span
                      style={{
                        fontSize: "12px",
                    ...
                    >
                      Giảm khoảng cách các dòng bảng dữ liệu để hiển thị nhiều
                ...
                >
                  ...
                  <div>
                    <strong>
                      Tự động làm mới số liệu Dashboard khi mở tab
                    </strong>
                    <span
                      style={{
                        fontSize: "12px",
                    ...
                    >
                      Luôn gọi lại API thống kê khi chuyển hướng quay lại bảng
                      điều khiển.
                    </span>
                  </div>
                </label>
